...
protected:
    ...
    double d_force_stabilization_eps = 0.0, d_velocity_stabilization_eps = 0.0, d_fluid_traction_stabilization_eps = 0.0, d_pressure_extrapolate_stabilization_eps = 0;
