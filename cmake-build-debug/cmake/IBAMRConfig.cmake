...
SET(IBAMR_C_FLAGS "-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Users/qisun/anaconda3/include")
SET(IBAMR_CXX_FLAGS "-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -stdlib=libc++ -fvisibility-inlines-hidden -std=c++14 -fmessage-length=0 -isystem /Users/qisun/anaconda3/include -Wno-undefined-var-template -Wno-unneeded-internal-declaration")
SET(IBAMR_Fortran_FLAGS "")

IF(NOT "/usr/local/bin/../" STREQUAL "")
  # CMake wants to detect MPI with MPI_HOME, not MPI_ROOT (which we set up)
  SET(MPI_HOME "/usr/local/bin/../")
ENDIF()
