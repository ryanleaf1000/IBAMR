...
c
     ...
     &          ifirst2-nFgc2:ilast2+nFgc2,0:3-1)
c
c     Local variables.
c
      integer ic0,ic1,ic2
...
c
     ...
     &          ifirst2-nugc2:ilast2+nugc2)
      double precision u2(ifirst0-nugc0:ilast0+nugc0,
     &          ifirst1-nugc1:ilast1+nugc1,
     &          ifirst2-nugc2:ilast2+1+nugc2)
...
c
     ...
     &          ifirst2-nfgc2:ilast2+nfgc2)
      double precision f2(ifirst0-nfgc0:ilast0+nfgc0,
     &          ifirst1-nfgc1:ilast1+nfgc1,
     &          ifirst2-nfgc2:ilast2+1+nfgc2)
c
c     Local variables.
c
      integer ic0,ic1,ic2
