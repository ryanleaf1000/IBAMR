...
c     C type that corresponds to, so use an integer
     ...
     &        ifirst0-nQgc0:ilast0+nQgc0)
      double precision Q2(ifirst2-nQgc2:ilast2+nQgc2,
     &        ifirst0-nQgc0:ilast0+nQgc0,
     &        ifirst1-nQgc1:ilast1+nQgc1)
     ...
     &          ifirst0-nqhalfgc0:ilast0+nqhalfgc0)
      double precision qtemp2(ifirst2-nqhalfgc2:ilast2+1+nqhalfgc2,
     &          ifirst0-nqhalfgc0:ilast0+nqhalfgc0,
     &          ifirst1-nqhalfgc1:ilast1+nqhalfgc1)
c
c     Input/Output.
...
c     C type that corresponds to, so use an integer
     ...
     &               ifirst2-nQgc2:ilast2+nQgc2,
     &               ifirst0-nQgc0:ilast0+nQgc0)
      double precision Qscratch2(ifirst2-nQgc2:ilast2+nQgc2,
     &               ifirst0-nQgc0:ilast0+nQgc0,
     &               ifirst1-nQgc1:ilast1+nQgc1)
     ...
     &               ifirst0-nFgc0:ilast0+nFgc0)
      double precision Fscratch2(ifirst2-nFgc2:ilast2+nFgc2,
     &               ifirst0-nFgc0:ilast0+nFgc0,
     &               ifirst1-nFgc1:ilast1+nFgc1)
...
c     C type that corresponds to, so use an integer
     ...
     &        ifirst2-nFgc2:ilast2+nFgc2,
     &        ifirst0-nFgc0:ilast0+nFgc0)
      double precision F2(ifirst2-nFgc2:ilast2+nFgc2,
     &        ifirst0-nFgc0:ilast0+nFgc0,
     &        ifirst1-nFgc1:ilast1+nFgc1)
...
c
     ...
     &          ifirst2-ngradgc2:ilast2+ngradgc2)
      double precision grad1(ifirst1-ngradgc1:ilast1+1+ngradgc1,
     &          ifirst2-ngradgc2:ilast2+ngradgc2,
     &          ifirst0-ngradgc0:ilast0+ngradgc0)
      double precision grad2(ifirst2-ngradgc2:ilast2+1+ngradgc2,
     &          ifirst0-ngradgc0:ilast0+ngradgc0,
     &          ifirst1-ngradgc1:ilast1+ngradgc1)
c
c     Input/Output.
...
c
      integer ic0,ic1,ic2
      double precision Qy,Qz,qL_diff,qR_diff
      double precision vtan,wtan
c
...
c
      integer ic0,ic1,ic2
      double precision Qy,Qyupwind,Qz,Qzupwind,qL_diff,qR_diff
      double precision vtan,vtanupwind,wtan,wtanupwind
      double precision vDywQz,wDzvQy
c
c     Add transverse derivitives by taking centered differences of
c     temporary predicted values.
c
