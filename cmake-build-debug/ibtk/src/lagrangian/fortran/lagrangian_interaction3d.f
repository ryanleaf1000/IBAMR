...
c
      ...
      double precision Xshift(0:3-1,0:nindices-1)

      double precision dx(0:3-1),x_lower(0:3-1),x_upper(0:3-1)
      double precision u(ilower0-nugc0:iupper0+nugc0,
     &          ilower1-nugc1:iupper1+nugc1,
     &          ilower2-nugc2:iupper2+nugc2,0:depth-1)
      double precision X(0:3-1,0:*)
c
c     Input/Output.
c
...
c     Local variables.
c
      integer ilower(0:3-1),iupper(0:3-1)
      integer ic0,ic1,ic2
      integer ic_center(0:3-1),ic_lower(0:3-1),ic_upper(0:3-1)
      integer ic_trimmed_lower(0:3-1),ic_trimmed_upper(0:3-1)
      integer d,l,s,nugc(0:3-1)

      double precision X_cell(0:3-1),X_shifted(0:3-1),w(0:3-1,0:1)
c
c     Prevent compiler warning about unused variables.
c
      x_upper(0) = x_upper(0)
...
c
      ...
      double precision X_cell(0:3-1),w(0:3-1,0:3)
c
c     Prevent compiler warning about unused variables.
c
      x_upper(0) = x_upper(0)
...
c     Interpolate u onto V.
c
            if (ic_upper(2) - ic_lower(2) == (4 - 1) .and.
     &       ic_upper(1) - ic_lower(1) == (4 - 1) .and.
     &       ic_upper(0) - ic_lower(0) == (4 - 1)) then
            do d = 0,depth-1
               V(d, s) = 0.d0
               do ic2 = ic_lower(2),(ic_lower(2) + 4 - 1)
...
c
      ...
      double precision X_cell(0:3-1),w(0:3-1,0:2)
c
c     Prevent compiler warning about unused variables.
c
      x_upper(0) = x_upper(0)
...
c     Interpolate u onto V.
c
            if (ic_upper(2) - ic_lower(2) == (3 - 1) .and.
     &       ic_upper(1) - ic_lower(1) == (3 - 1) .and.
     &       ic_upper(0) - ic_lower(0) == (3 - 1)) then
            do d = 0,depth-1
               V(d, s) = 0.d0
               do ic2 = ic_lower(2),(ic_lower(2) + 3 - 1)
...
c
      ...
      integer ig_lower(0:3-1),ig_upper(0:3-1)
      integer ic_lower(0:3-1),ic_upper(0:3-1)
      integer istart0,istop0,istart1,istop1,istart2,istop2
      integer d,l,s

      double precision X_o_dx,q0,q1,q2,r0,r1,r2
      double precision w0(0:3),w1(0:3),w2(0:3)
      double precision w(0:3,0:3,0:3),wyz,wz
c
c     Prevent compiler warning about unused variables.
c
      x_upper(0) = x_upper(0)
...
c
      ...
      double precision X_o_dx,q0,q1,q2,r0,r1,r2
      double precision w0(0:7),w1(0:7),w2(0:7)
      double precision w(0:7,0:7,0:7),wyz,wz
c
c     Prevent compiler warning about unused variables.
c
      x_upper(0) = x_upper(0)
...
c
      ...
      double precision X_cell(0:3-1),w0(0:4),w1(0:4),w2(0:4)
...
c
      ...
      double precision w0(0:5),w1(0:5),w2(0:5)
      double precision w(0:5,0:5,0:5),wyz,wz
...
c
      ...
      double precision X_cell(0:3-1),w(0:3-1,0:4)
c
c     Prevent compiler warning about unused variables.
c
      x_upper(0) = x_upper(0)
...
c     Interpolate u onto V.
c
            if (ic_upper(2) - ic_lower(2) == (5 - 1) .and.
     &       ic_upper(1) - ic_lower(1) == (5 - 1) .and.
     &       ic_upper(0) - ic_lower(0) == (5 - 1)) then
            do d = 0,depth-1
               V(d, s) = 0.d0
               do ic2 = ic_lower(2),(ic_lower(2) + 5 - 1)
...
c
      ...
      double precision X_cell(0:3-1),w(0:3-1,0:5)
c
c     Prevent compiler warning about unused variables.
c
      x_upper(0) = x_upper(0)
...
c     Interpolate u onto V.
c
            if (ic_upper(2) - ic_lower(2) == (6 - 1) .and.
     &       ic_upper(1) - ic_lower(1) == (6 - 1) .and.
     &       ic_upper(0) - ic_lower(0) == (6 - 1)) then
            do d = 0,depth-1
               V(d, s) = 0.d0
               do ic2 = ic_lower(2),(ic_lower(2) + 6 - 1)
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine lagrangian_composite_bspline_32_interp3d(
     &     dx,x_lower,x_upper,depth,axis,
     &     ilower0,iupper0,ilower1,iupper1,ilower2,iupper2,
     &     nugc0,nugc1,nugc2,
     &     u,
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine lagrangian_composite_bspline_32_spread3d(
     &     dx,x_lower,x_upper,depth,axis,
     &     indices,Xshift,nindices,
     &     X,V,
     &     ilower0,iupper0,ilower1,iupper1,ilower2,iupper2,
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine lagrangian_composite_bspline_43_interp3d(
     &     dx,x_lower,x_upper,depth,axis,
     &     ilower0,iupper0,ilower1,iupper1,ilower2,iupper2,
     &     nugc0,nugc1,nugc2,
     &     u,
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine lagrangian_composite_bspline_43_spread3d(
     &     dx,x_lower,x_upper,depth,axis,
     &     indices,Xshift,nindices,
     &     X,V,
     &     ilower0,iupper0,ilower1,iupper1,ilower2,iupper2,
