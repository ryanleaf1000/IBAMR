...
c
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      double precision function a_avg4(a0,a1,a2,a3)
      implicit none
...
c
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      double precision function a_avg12(a0,a1,a2,a3,
     &                      a4,a5,a6,a7,
     &                      a8,a9,a10,a11)
      implicit none
      double precision a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11
...
c
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      double precision function h_avg2(a0,a1)
      implicit none
      double precision a0,a1
      double precision dmr,nmr, eps
      nmr = 2.d0
...
c
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      double precision function h_avg4(a0,a1,a2,a3)
      implicit none
      double precision a0,a1,a2,a3
      double precision dmr,nmr,eps
      nmr = 4.d0
...
c
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      double precision function h_avg12(a0,a1,a2,a3,
     &                      a4,a5,a6,a7,
     &                      a8,a9,a10,a11)
      implicit none
      double precision a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11
