...
c
      ...
      double precision acoef(blower1:bupper1,blower2:bupper2)
      double precision bcoef(blower1:bupper1,blower2:bupper2)
      double precision gcoef(blower1:bupper1,blower2:bupper2)
...
c
      ...
      integer k
      integer sgn
      double precision    a,b,f_g,f_i,g,h,n,u_g,u_i
c
...
c
      ...
      double precision acoef(blower0:bupper0,blower2:bupper2)
      double precision bcoef(blower0:bupper0,blower2:bupper2)
      double precision gcoef(blower0:bupper0,blower2:bupper2)
...
c
      ...
      integer k
      integer sgn
      double precision    a,b,f_b,f_g,f_i,g,h,n,u_b,u_g,u_i
c
c     Initialize temporary variables to yield errors.
c
      u_b = 2.d0**15.d0
...
c
     ...
     &                       - del*u1(i,j,k_bdry+k_shift)
         ...
         do k = blower2,bupper2+1
            if ( (k .lt. ilower2) .or. (k .gt. iupper2+1) ) then
               do j = blower1,bupper1
                  do i = blower0,bupper0
...
c
      ...
      integer j,j_bdry,j_shift
      integer k,k_bdry,k_shift
      double precision u_g,del_i,del_j,del_k
c
c     Initialize index variables to yield errors in most cases.
c
      i       = 2**15
...
c
      ...
      integer k
      integer sgn
      double precision    a,b,f_b,f_g,f_i,f_i2,g,h,n,u_b,u_g,u_i,u_i2
c
c     Initialize temporary variables to yield errors.
c
      u_b = 2.d0**15.d0
