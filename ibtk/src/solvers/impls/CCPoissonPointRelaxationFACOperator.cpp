                                                     ...
                                                     int finest_level_num)
{
    ...
    Pointer<CellNoCornersFillPattern> fill_pattern = nullptr; //new CellNoCornersFillPattern(CELLG, false, false, true);
                                                                        ...
                                                                        const int finest_reset_ln)
{
    ...
    d_op_stencil_fill_pattern = nullptr; //new CellNoCornersFillPattern(CELLG, true, false, false);
