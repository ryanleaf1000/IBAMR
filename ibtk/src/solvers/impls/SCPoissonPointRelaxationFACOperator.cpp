                                                     ...
                                                     int finest_level_num)
{
    ...
    Pointer<SideNoCornersFillPattern> fill_pattern = nullptr;// new SideNoCornersFillPattern(d_gcw.max(), false, false, true);
                                                                        ...
                                                                        const int finest_reset_ln)
{
    ...
    {
        d_op_stencil_fill_pattern = nullptr; //new SideNoCornersFillPattern(d_gcw.max(), true, false, false);
    }
    else
    {
