...
c
      ...
      do i1 = ilower1,iupper1
         do i0 = ilower0,iupper0
            F(i0,i1) =
     &           10/12*fac0*(U(i0-1,i1)+U(i0+1,i1)-2.d0*U(i0,i1)) +
     &           1/12*fac0*(U(i0-1,i1-1)+U(i0+1,i1-1)-2.d0*U(i0,i1-1)) +
     &           1/12*fac0*(U(i0-1,i1+1)+U(i0+1,i1+1)-2.d0*U(i0,i1+1)) +
     &           10/12*fac1*(U(i0,i1-1)+U(i0,i1+1)-2.d0*U(i0,i1)) +
     &           1/12*fac1*(U(i0-1,i1-1)+U(i0-1,i1+1)-2.d0*U(i0-1,i1)) +
     &           1/12*fac1*(U(i0+1,i1-1)+U(i0+1,i1+1)-2.d0*U(i0+1,i1))
         enddo
      enddo
c
