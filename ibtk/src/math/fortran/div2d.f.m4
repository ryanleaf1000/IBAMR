...
c
      ...
      do i1 = ilower1,iupper1
         do i0 = ilower0,iupper0
            D(i0,i1) =
     &           11.0/12*fac0*(U(i0+1,i1,0)-U(i0-1,i1,0)) +
     &          1.0/24*fac0*(U(i0+1,i1+1,0)-U(i0-1,i1+1,0)) +
     &          1.0/24*fac0*(U(i0+1,i1-1,0)-U(i0-1,i1-1,0)) +
     &          11.0/12*fac1*(U(i0,i1+1,1)-U(i0,i1-1,1)) +
     &          1.0/24*fac1*(U(i0-1,i1+1,1)-U(i0-1,i1-1,1)) +
     &          1.0/24*fac1*(U(i0+1,i1+1,1)-U(i0+1,i1-1,1))
         enddo
      enddo
c
...
c
      ...
      do i1 = ilower1,iupper1
         do i0 = ilower0,iupper0
            D(i0,i1) =
     &           11.0/12*fac0*(u0(i0+1,i1)-u0(i0,i1)) +
     &           1.0/24*fac0*(u0(i0+1,i1+1)-u0(i0,i1+1)) +
     &           1.0/24*fac0*(u0(i0+1,i1-1)-u0(i0,i1-1)) +
     &           11.0/12*fac1*(u1(i1+1,i0)-u1(i1,i0)) +
     &           1.0/24*fac1*(u1(i1+1,i0+1)-u1(i1,i0+1)) +
     &           1.0/24*fac1*(u1(i1+1,i0-1)-u1(i1,i0-1))
         enddo
      enddo
c
...
c
     ...
     &        1.0/24*fac0*(u0(i0+1,i1+1)-u0(i0,i1+1)) +
     &        1.0/24*fac0*(u0(i0+1,i1-1)-u0(i0,i1-1)) +
     &        11.0/12*fac1*(u1(i0,i1+1)-u1(i0,i1)) +
     &        1.0/24*fac1*(u1(i0+1,i1+1)-u1(i0+1,i1)) +
     &        1.0/24*fac1*(u1(i0-1,i1+1)-u1(i0-1,i1))
         enddo
      enddo
c
